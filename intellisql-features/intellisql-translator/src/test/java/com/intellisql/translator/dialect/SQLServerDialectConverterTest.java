...
/**
 * Unit tests for {@link SQLServerDialectConverter}.
 */
class SQLServerDialectConverterTest {

    private SQLServerDialectConverter converter;

    @BeforeEach
    void setUp() {
        converter = new SQLServerDialectConverter();
    }
